...
class AppToDo: 
    ...
    def criar_cabecalho(self):
        return ft.Container( 
            ...
            ], alignment=ft.MainAxisAlignment.CENTER, spacing=5), padding=ft.padding.symmetric(vertical=20)
        ) 
    ...
    def criar_secao_entrada(self):  
        self.entrada_tarefa = ft.TextField( 
            ...
            text_style=ft.TextStyle(color=self.cor['texto']), hint_style=ft.TextStyle(color=self.cor['texto_secundario']), bgcolor=self.cor['item_fundo'], 
            border_radius=8, 
        )
    ...
    def criar_abas(self):
        self.abas = ft.Tabs( 
            ...
            tabs=[ 
                ...
                ft.Tab(text="Concluidas", icon=ft.icons.TASK_ALT)
            ],
